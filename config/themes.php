...
return [
    ...
    */
    ...
    'themes_path' => (('resources')), // eg: realpath(base_path('resources/themes'))
	...
	*/
	...
	'themes' => [
        ...
        'organic' => [
            'views-path' => 'resources/views/theme/organic'
        ],
		...
		/*--------------[ Example Structure ]-------------
			...
			// Recommended (all defaults) : Assets -> \public\BasicTheme , Views -> \resources\views\BasicTheme
