                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <input name="title" type="text" class="form-control" placeholder="Enter title" value="{{ $article->title }}">
                        ...
                        <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            ...
                            <textarea name="content" id="summernote" class="hidden">{{ $article->content }}</textarea>
